...
def build_state():
    ...
    return clean({
        "status":"ok","version":"V2.28.29 / V10.39.17",
        "server_time":now,
        "market":{
...
def prospective_instrumentation_tick(d):
    ...
    if now-_LAST_PROSPECTIVE_AT >= PROSPECTIVE_MIN_INTERVAL_S:
        ...
        rec={
            ...
            "app_version":"V2.28.29","research_version":"V10.39.17",
...
AUTO_PAPER={"enabled":True,"position":None,"decision_side":None,"decision_since":0.0,"last_shadow_key":None,"last_exit":None}
...
def _rdfz_manifest(files=None):
    ...
    return {"schema":"RDFZ_V2","app_version":"V2.28.29","research_version":"V10.39.17",
