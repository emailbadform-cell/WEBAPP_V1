...
def build_state():
    ...
    return clean({
        "status":"ok","version":"V2.28.7 / V10.39.2",
        "server_time":now,
        "market":{
...
app = FastAPI(title="BTC15M V2.28.7 / V10.39.2 Recursive GT + L2 + Predictive Decision", lifespan=lifespan)
