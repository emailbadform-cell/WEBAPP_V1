...
def build_state():
    ...
    return clean({
        "status":"ok","version":"V2.28.18 / V10.39.8",
        "server_time":now,
        "market":{
...
app = FastAPI(title="BTC15M V2.28.18 / V10.39.8 Event-Driven Auto Paper V1 + Instrumented Recursive GT", lifespan=lifespan)
