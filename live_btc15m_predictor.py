...
RESEARCH_LOG_FILE = RDFZ_DIR / "BTC15M_V10_39_11_RESEARCH_LOG.csv"
...
class LiveEngine(LiveEngine):
    ...
    def _ensure_market(self):
        ...
        if remaining<=300 and self.next_market is None and time.monotonic()-self.last_direct_prefetch>=0.5:
