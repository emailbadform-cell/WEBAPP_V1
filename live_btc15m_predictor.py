...
RESEARCH_LOG_FILE = RDFZ_DIR / "BTC15M_V10_39_13_RESEARCH_LOG.csv"
...
class LiveEngine(LiveEngine):
    ...
    def _ensure_market(self):
        ...
        prefetch_retry_s = 10.0 if remaining > 60 else (3.0 if remaining > 15 else (1.0 if remaining > 0 else 0.35))
