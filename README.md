...
## V2.28.35 RDFZ export fix
- Recognizes the timestamp fields actually emitted by current RDFZ streams.
- Captures each active file's byte boundary before scanning/exporting.
- Manifest accounting and ZIP contents are generated from the same frozen byte boundaries.
- Active logs continue appending; export remains cumulative and non-destructive.
- No trading/model logic changed.
